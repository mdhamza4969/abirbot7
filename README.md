...
<table>
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/sabbirmaghla">
        <img src="https://files.catbox.moe/ew7o9o.jpg" width="100px;" alt="XNIL6X"/>
        <br/>
        <sub><b>SABBIR HOSSEIN</b></sub>
      </a>
      <br/>
...
module.exports = {  
  config: {  
    ...
    version: "1.0",                      // 🔸 Version  
    author: "SABBIR",                    // 👨‍💻 Developer  
    role: 4,                             // 🔐 Required Access Level 
    premium: true,                       // 🌟 For Premium Access only Premium members
    cost: 100,                           // 💰 how much money need for use this command 
    ...
    cooldowns: 5                         // ⏳ Execution Delay (seconds)  
  }  
};
```
...
| 3     | 💎    | Bot Developers         | DEV command privileges       |
| 4     | 👑    | Won Role      | Full system control          |
...
- **Premium Control**  
  → `premium: true/false` for command set Only for premium member's
...
Enhanced by [SABBIR HOSSEIN](https://github.com/sabbirmaghla)
