// set bash title
process.stdout.write("\x1b]2;Goat Bot V2 - Made by NTKhang enhanced by SABBIR HOSSEIN\x1b\x5c");
...
const author = ("Created by NTKhang enhanced by SABBIR HOSSEIN♡");
const srcUrl = ("Source code: https://github.com/sabbirmaghla/SABBIR-Harny");
...
async function startBot(loginWithEmail) {
        ...
        (function loginBot(appState) {
                ...
                login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
                        ...
                        // —————————————————— COPYRIGHT INFO —————————————————— //
                        // console.log(`\x1b[1m\x1b[33mCOPYRIGHT:\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36mProject GoatBot v2 created by ntkhang03 enhanced by SABBIR HOSSEIN (https://github.com/sabbirmaghla), please do not sell this source code or claim it as your own. Thank you!\x1b[0m`);
                        console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("Project GoatBot v2 created by ntkhang03 enhanced by SABBIR HOSSEIN (https://github.com/sabbirmaghla), please do not sell this source code or claim it as your own. Thank you!")}\x1b[0m`);
                        logColor("#f5ab00", character);
