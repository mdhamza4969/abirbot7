...
𝑷𝑨𝑮𝑬 1 - 3\n\n╚════ஜ۩۞۩ஜ═══╝`,
    ...
    case "business":
      ...
      break;
    case "wall":apiUrl = `https://faheem-vip-010.faheem001.repl.co/api/textpro/embossed?text=${text}`;
    ...
    case "gradient":
      ...
      message = "here's the [𝑮𝑹𝑨𝑫𝑰𝑬𝑵𝑻] Logo created:";
        break;
    case "greenhorror":
      apiUrl = `https://faheem-vip-010.faheem001.repl.co/api/textpro/greenhorror?text=${text}`;message = "here's the [𝑮𝑹𝑬𝑬𝑵𝑯𝑶𝑹𝑹𝑶𝑹] Logo created:";
        break;
    case "spooky":
...
break;
    ...
    case "horror":
      ...
      message = "here's the [HORROR] Logo created:";
         break;
    case "writestatus":
      apiUrl = `https://faheem-vip-010.faheem001.repl.co/api/ephoto/writestatus?text=${text}&text2=Your%20Quotes%20In%20Herm`;message = "here's the [WRITESTATUS] Logo created:";
				 break;
    case "teamlogo":
